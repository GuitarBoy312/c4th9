    ...
    if st.session_state.question_data:
        ...
        if st.session_state.show_answer and st.session_state.last_checked_option:
            ...
            if is_correct:
                ...
                if st.session_state.question_type == "essay":
                    explanation = get_explanation_essay(question, passage, correct_answer, st.session_state.last_checked_option)
                else:
                    explanation = get_explanation_dialogue(question, dialogue, correct_answer, st.session_state.last_checked_option)
